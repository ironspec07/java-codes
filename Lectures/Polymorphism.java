...
- class A extends B  -- A class  has add(int, int) and B has add(int,int ) out of this two we can decide which will execute at run time then this is called run time polymorphism example.
 */